...
сq210 = 'Отлично! Вы открыли сундук и обнаружили, что там нет ничего ценного. Какая-то хрень, какой-то хлам: глянные черепки, куски истлевшей сгнившей одежды, мышиный помёт и паутина.'
...
{0: (c20, 'next', aс20), 10: (сq210, 'next', acq210), 110: (cq2110, 'end_chest', enus),20:(сq220, 'end', enus, ('go', 1))}, 
