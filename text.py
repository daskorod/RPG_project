...
a0 = "1.Поговорить. 2. Вступить в бой, без разговоров. Эта тварь должна умереть. 3. Уйти восвояси."
...
zombi1 = {0: (z0, "next", a0), 10: (z10, "next", a10), 20: (z20, "war", empty), 30: (z30, "end", a10), 110 : (z110, 'end', a110), 210: (z210, 'end', а210)}