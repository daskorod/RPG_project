...
old_sword = Weapon ('Ржавый меч', "Ржавый и старый меч. Весь в зазубринах и сделан из какого-то некачественного металла. Но, впрочем, им можно сражаться. Урон 1.", 5, 1, '1 - экипировать/снять; 2 - выбросить.', at_mod = +2)
short_sword = Weapon ('Короткий меч', "Довольно качественная вещь. Урон 1.", 20, 1, '1 - экипировать/снять; 2 - выбросить.')
long_sword = Weapon ('Длинный меч', "Очень опасная вещь. Урон 2.", 100, 2, '1 - экипировать/снять; 2 - выбросить.')
great_sword = Weapon ('Двуручный меч', "Вот им можно заехать так заехать. Урон 3.", 420, 3, '1 - экипировать/снять; 2 - выбросить.')
...
gold_ring = Item ('Золотое кольцо.', "Красивое золтое кольцо, украшенное драгоценными камням. Наверное его можно продать очень задорого!", 200)
...
garbage2 = Item ('Мёртвая крыса', 'Откуда пришла эта крыса? Крыс снаружи нет, они приходят изнутри.', 3)
...
garbage8 = Item ('Пустая бутылка', 'Глинянная старая треснувшая бутылка. Можно сдать на черепки.', 1)

garbage_collection = [bouquet,garbage2,garbage3,garbage4,garbage5,garbage6,garbage7,garbage8]